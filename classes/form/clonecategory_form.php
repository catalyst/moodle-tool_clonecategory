...
class clonecategory_form extends \moodleform {
    ...
    public function definition() {
        ...
        $buttonlabel = get_string('clone_courses', 'local_clonecategory');
        ...
        $mform->addElement('text', 'destcategoryname', get_string('destination_category_name', 'local_clonecategory'),
            ['size' => '30']);
        $mform->setType('destcategoryname', PARAM_TEXT);
        $mform->addHelpButton('destcategoryname', 'categoryname', 'local_clonecategory');
        $mform->addElement('text', 'destcategoryidnumber', get_string('destination_category_idnumber', 'local_clonecategory'),
            ['size' => '30']);
